  ...
  return (
    <html lang="en" className="dark bg-background">
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=DotGothic16&family=Stack+Sans+Headline:wght@200..700&family=Stack+Sans+Text:wght@200..700&display=swap"
          rel="stylesheet"
        />
        <script
      ...
      <body
        className={`${ibmPlexMono.variable} font-sans antialiased overflow-x-hidden`}
      >
